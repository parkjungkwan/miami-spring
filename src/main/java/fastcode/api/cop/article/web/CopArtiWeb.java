package fastcode.api.cop.article.web;
...
import com.bitcamp.lms.bbs.serviceImpl.ArticleServiceImpl;
...
@RestController
@RequestMapping("/bbs/articles")
public class CopArtiWeb extends CrudController<Article>{
    private final Page page;
    private final Box<Article> box;
    private final ArticleServiceImpl service;
    
    @PostMapping("")
    public ResponseEntity<Integer> save(@RequestBody Article param) {
        return ResponseEntity.ok(service.save(param));
    }
    @PutMapping("")
    public ResponseEntity<Integer> update(@RequestBody Article param){
    ...
    @DeleteMapping("")
    public ResponseEntity<Integer> delete(@RequestBody Article param){
    ...
    public ResponseEntity<Box<Article>> findAll(@PathVariable String pageNo) {
    	page.setPageNo(integer.apply(pageNo));
    	List<Article> list = service.findAll(page);
    	box.setList(list);
    	box.setPage(page);
