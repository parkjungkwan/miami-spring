...
import fastcode.api.cop.article.service.vo.WriteMgmtVO;
import org.springframework.stereotype.Repository;

@Repository
public interface DbDAO extends AppDAO<ComponentVO> {
	...
	public List<WriteMgmtVO> getTest();
	public List<WriteMgmtVO> existTable();
